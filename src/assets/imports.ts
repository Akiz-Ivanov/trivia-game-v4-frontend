import type { Category, SvgModule } from "../types/imports";
...
const categoryLoaders: Record<Category, () => Promise<SvgModule>> = {
  ...
  "Entertainment: Musicals & Theatres": () =>
    import("./svgs/entertainment-musicals-theatres.svg"),
  "Entertainment: Television": () =>
    import("./svgs/entertainment-television.svg"),
  "Entertainment: Video Games": () =>
    import("./svgs/entertainment-video-games.svg"),
  "Entertainment: Board Games": () =>
    import("./svgs/entertainment-board-games.svg"),
...
export async function preloadAllCategoryImages() {
  const entries = Object.entries(categoryLoaders) as [
    Category,
    () => Promise<SvgModule>,
  ][];
  await Promise.all(
