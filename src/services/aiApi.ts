...
import { EXTRA_INFO_SYSTEM_PROMPT, HINT_SYSTEM_PROMPT } from "./aiPrompts";
...
//*====== API URL & KEY ======//
const DEEPINFRA_API_URL: string =
...
Add trivia flavor and provide informative or fun context (DO NOT CORRECT, DO NOT REPEAT ANSWER OR QUESTION):`;
  ...
  return fetchAIResponse({
    prompt: userPrompt,
    systemPrompt: EXTRA_INFO_SYSTEM_PROMPT,
    signal,
  });
};
