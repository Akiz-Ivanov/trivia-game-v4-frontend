    ...
    <div className={cn("relative inline-flex items-center justify-center", className)}>
      <svg width={size} height={size} className="transform -rotate-90">
        ...
        <defs>
          ...
          <linearGradient id="outerRingShade" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="white" stopOpacity="0.6" />     {/* top-left highlight */}
            <stop offset="40%" stopColor="#e5e7eb" stopOpacity="0.3" />  {/* soft transition */}
            <stop offset="100%" stopColor="#111827" stopOpacity="0.4" /> {/* bottom-right shadow */}
          </linearGradient>
